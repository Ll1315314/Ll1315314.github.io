...
- **08-06** · [把 1500 行自动化删掉——像素阈值里藏着一台特定的屏幕](/blog/2026-08-06-deleting-screen-automation)
  <br><small>换屏幕后判据失准，还把失败误报成成功。最后留下的是人做会悄悄做错的那部分。</small>

- **07-31** · [批量发布的难点不是点按钮，是记账——10 账号 × 205 条视频的排期设计](/blog/2026-07-31-batch-publish-scheduling)
